...
const Footer = () => {
  return (
    <footer className="bg-[#2b5043] text-white pt-16 pb-8 px-4 md:px-8 font-sans">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex space-x-4 mb-16">
          {/* Instagram Icon */}
          <a href="#" className="bg-white text-[#2b5043] p-2.5 rounded-full hover:bg-gray-200 transition duration-300 flex items-center justify-center w-10 h-10">
